    ...
    <?php if (current_user_can('editor') || current_user_can('administrator')) {  ?>
        ...
        <div class="content">
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                $phone = get_field('nr_telefonu');
                $phone = $phone ? $phone : "Brak";

                $client_id = get_the_ID();
                ?>
                <dt>
                <dd><strong>Adres:</strong> <?php echo $address; ?></dd>
                <dd><strong>Kod pocztowy:</strong> <?php echo $postal_code; ?></dd>
                <dd><strong>E-mail:</strong> <?php echo $email; ?></dd>
                <dd><strong>Nr telefonu:</strong> <?php echo $phone; ?></dd>
                </dt>
