...
jQuery(function ($) {
    $("#content .slider > div:gt(0)").hide();

    setInterval(function () {
        $("#content .slider > div:first")
            .fadeOut(1000)
            .next()
            .fadeIn(1000)
            .end()
            .appendTo("#content .slider");
    }, 5000);

    function menu_width() {
        var header_width = $("header .container .row").width();
        $("header ul.hide-on-med-and-down").width(header_width - 420);
    }

    function main_height() {
        var window_height = $(window).height();
        $("#content.main, #content.main .slide, #content .slider_bg").height(
            window_height
        );
    }
    ...
    function images() {
        /*$('#content .content .gallery .box .boxInner img').each(function() {
        ...
        //console.log($('#content .content .gallery .box .boxInner img'));
    }

    $("img.lazy").lazyload({
        threshold: 300,
        placeholder: "http://sylwesterszymczuk.com/wp-content/themes/sylwester_portfolio2/img/logo.png",
        load: function () {
            //images();
        },
    });
    ...
    //   afterOpen: function() {
    //     FB.XFBML.parse(document.getElementById("face"));
    //   },
    //   nextSlide: function() {
    //     FB.XFBML.parse(document.getElementById("face"));
    //   },
    ...
    if (window.location.hash && window.location.hash.substr(1) == "category") {
        $("html,body").animate({
                scrollTop: $(".box.category").offset().top - 95,
            },
            "slow"
        );
    ...
    if (scrollonscreen > $(".box.category").offset().top) {
    ...
    var footer_input = $("#footer_search_input");
    var footer_search = $(".footer_search form");
    var search_error = footer_search.find(".footer_search_error");
    ...
    footer_search.submit(function (e) {
        ...
        if (val.length < 3) {
            ...
            window.location = "/szukaj/" + val + "/";
        }
    });

    footer_input.on("input", function () {
    ...
    // if (
    //   window.location.pathname == "/kulturystyka-i-fitness/reportaze/" ||
    //   window.location.pathname == "/kulturystyka-i-fitness/sesje-bb-2/"
    // )
    //   $(".nav-wrapper ul.hide-on-med-and-down li:first-child").addClass(
    //     "current-menu-item"
    //   );

    // if ($("#menu-item-2962").hasClass("current-menu-item")) {
    //   $("#menu-item-1132").removeClass("current-menu-item");
    // }
